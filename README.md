...
> **Award-winning project** — Winner of the 2023 HPCC Systems Poster Competition in both the *Data Analytics* and *Community Choice* categories.
...
The project was developed as a thesis for the Bachelor of Science in Electrical Engineering at the **University of São Paulo (USP)**, in collaboration with mentors from **LexisNexis Risk Solutions**.

[View the award-winning research poster](poster.pdf)
...
Running `cvd_research.py` generates a grouped bar chart comparing all five classifiers
across Accuracy, Precision, Recall, F1-Score, and AUC, saved to `outputs/model_comparison.png`.
